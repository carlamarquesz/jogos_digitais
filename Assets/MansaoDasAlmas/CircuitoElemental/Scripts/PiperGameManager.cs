...
public class PiperGameManager : MonoBehaviour
{
    ...
    public string cenaProxima = "Corredor4";     // Nome da cena para onde ir ao vencer
    public string cenaAnterior = "Corredor3"; // Cena para voltar ao pressionar F
    ...
    void Start()
    {
        ...
        for (int i = 0; i < totalPipes; i++)
        {
            ...
            var pipeScriptComponent = Pipes[i].GetComponent<pipeScript>();
